 ...
 */
function ErrorsStatsBar({ errorStats }: { errorStats: DashboardData["errorStats"] }) {
	...
	const validationPct = ((errorStats.validation / errorsTotal) * 100).toFixed(0);
	...
	return (
		<div class="table-container">
			...
			<div class="pagination-controls" id="jobs-pagination">
				<button class="pagination-btn jobs-first-btn">First</button>
				<button class="pagination-btn jobs-prev-btn">Previous</button>
				<span class="page-info">Page 1 of {totalPages}</span>
				<button class="pagination-btn jobs-next-btn">Next</button>
				<button class="pagination-btn jobs-last-btn">Last</button>
			</div>
		</div>
	);
}
...
function JobRow({ job }: { job: DashboardData["jobs"][0] }) {
	...
	return (
		<tr class={isFailed ? "job-row-failed clickable" : ""} data-job-id={isFailed ? job.id : undefined}>
			<td>{job.jobType}</td>
			<td>
	...
	return (
		<div class="table-container">
			...
			<div class="pagination-controls" id="errors-pagination">
				<button class="pagination-btn errors-first-btn">First</button>
				<button class="pagination-btn errors-prev-btn">Previous</button>
				<span class="page-info">Page 1 of {totalPages}</span>
				<button class="pagination-btn errors-next-btn">Next</button>
				<button class="pagination-btn errors-last-btn">Last</button>
			</div>
		</div>
	);
}
